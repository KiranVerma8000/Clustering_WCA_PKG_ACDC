...
class JavaClusterRunner:
    def __init__(self, jar_path, max_memory="14024m", algo="LIMBO", language="java",
                 deps_path="", measure="IL", proj_name="", proj_version="",
    ...
    def run(self):
        command = [
            ...
            f"serialthreshold={self.serial_threshold}"
        ]
...
if __name__ == "__main__":
    ...
    output_clustering_directory = "outputs/limbo_outputs"  # Separate output directory for clustering results
